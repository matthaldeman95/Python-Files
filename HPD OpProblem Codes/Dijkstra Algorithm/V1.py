...
mpl.rcParams['figure.dpi'] = mpl.rcParams['savefig.dpi'] = 300      #Set DPI for map/plots

g = nx.read_shp("data/tl_2013_06_prisecroads.shp")                  #Load shapefile using NetworkX, name g
sg = list(nx.connected_component_subgraphs(g.to_undirected()))[0]   #Take largest connected subgraph
len(sg)
...
def get_path_length(path):                              #Computes the length of a path
